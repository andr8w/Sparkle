...
- initForBundle:(NSBundle *)bundle
{
	...
	else if (self)
	{
		...
		[self performSelector:@selector(startUpdateCycle) withObject:nil afterDelay:0 inModes:[NSArray arrayWithObjects:NSDefaultRunLoopMode, NSModalPanelRunLoopMode, nil]];
	}
	return self;
}
